...
public class DiskCacheWriteProducer implements Producer<EncodedImage> {
    ...
    private void maybeStartInputProducer(Consumer<EncodedImage> consumerOfDiskCacheWriteProducer,
    ...
    private static class DiskCacheWriteConsumer
        ...
        private DiskCacheWriteConsumer(final Consumer<EncodedImage> consumer, final ProducerContext producerContext,
